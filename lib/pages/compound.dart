...
class CalculateCompound extends StatefulWidget {
  @override
  _CalculateCompoundState createState() => _CalculateCompoundState();
}

class _CalculateCompoundState extends State<CalculateCompound> {
  GlobalKey<FlipCardState> cardKey =
      GlobalKey<FlipCardState>(); //manage flip state
  final _scaffoldKey = GlobalKey<ScaffoldState>(); //to save the context

  CalculateSimple calculateSimple = CalculateSimple();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
          title: Text("Compound Calculator"),
          elevation: 0.0,
